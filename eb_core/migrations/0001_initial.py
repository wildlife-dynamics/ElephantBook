# Generated by Django 3.2 on 2021-08-18 02:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(models.Q(('app_label', 'eb_core'), ('model', 'individual_photo')), models.Q(('app_label', 'eb_core'), ('model', 'sighting_photo')), _connector='OR'), null=True, on_delete=django.db.models.deletion.PROTECT, to='contenttypes.contenttype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, default='')),
                ('group_sighting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eb_core.group_sighting')),
                ('individual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='eb_core.individual')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individual_sighting', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='eb_core.individual_sighting')),
            ],
        ),
        migrations.CreateModel(
            name='Social_Sighting',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notes', models.TextField(blank=True, default='')),
                ('group_sighting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eb_core.group_sighting')),
                ('individual_sightings', models.ManyToManyField(blank=True, to='eb_core.Individual_Sighting')),
                ('unphotographed_individuals', models.ManyToManyField(blank=True, to='eb_core.Individual')),
            ],
        ),
        migrations.CreateModel(
            name='Sighting_Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('w', models.FloatField()),
                ('h', models.FloatField()),
                ('individual_sighting', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='eb_core.individual_sighting')),
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eb_core.sighting_photo')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, default='')),
                ('individual_sighting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eb_core.individual_sighting')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compressed_image', models.ImageField(unique=True, upload_to='')),
                ('thumbnail', models.ImageField(null=True, unique=True, upload_to='')),
                ('individual', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eb_core.individual')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('w', models.FloatField()),
                ('h', models.FloatField()),
                ('individual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='eb_core.individual')),
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eb_core.individual_photo')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='group_sighting',
            name='unphotographed_individuals',
            field=models.ManyToManyField(blank=True, to='eb_core.Individual'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Search_Model',
            fields=[
                ('seek_identity_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='eb_core.seek_identity')),
                ('binary', models.BooleanField(default=False)),
                ('individual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='eb_core.individual')),
            ],
            bases=('eb_core.seek_identity',),
        ),
    ]
